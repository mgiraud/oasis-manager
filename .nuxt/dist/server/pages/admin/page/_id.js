...
"use strict";
/* harmony import */ var _src_components_VTextarea_VTextarea_sass__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(293);
...
var external_date_fns_ = __webpack_require__(207);

// EXTERNAL MODULE: external "date-fns/locale"
var locale_ = __webpack_require__(208);
...
var PageCategoryStore = __webpack_require__(299);

// EXTERNAL MODULE: ./app/custom-store/PageLogStore.ts
var PageLogStore = __webpack_require__(339);
...
var VTextarea = __webpack_require__(338);
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./app/pages/admin/page/_id.vue?vue&type=template&id=3fe7aa1b&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('v-container',[(_vm.state.error)?_c('v-row',[_c('v-col',{attrs:{"cols":"12"}},[_c('v-alert',{attrs:{"type":"error"}},[_vm._v("\n        "+_vm._s(_vm.state.error)+"\n      ")])],1)],1):_vm._e(),_vm._v(" "),_c('v-row',[_c('v-col',{attrs:{"cols":"12"}},[(_vm.item)?_c('Form',{ref:"updateForm",attrs:{"values":_vm.item,"errors":_vm.state.violations,"page-logs":_vm.pageLogs}}):_vm._e()],1)],1),_vm._v(" "),_c('v-row',[_c('v-col',{attrs:{"cols":"12"}},[_c('Toolbar',{attrs:{"handle-submit":_vm.onSendForm,"handle-reset":_vm.resetForm,"handle-delete":_vm.canDelete ? _vm.del : null,"handle-back":_vm.back},scopedSlots:_vm._u([{key:"left",fn:function(){return [(_vm.item)?_c('h1',[_vm._v("\n            Edit "+_vm._s(_vm.item['url'])+"\n          ")]):_vm._e()]},proxy:true}])})],1)],1),_vm._v(" "),_c('Loading',{attrs:{"visible":_vm.state.isLoading}})],1)}
var staticRenderFns = []


// CONCATENATED MODULE: ./app/pages/admin/page/_id.vue?vue&type=template&id=3fe7aa1b&
  ...
  setup() {
    ...
    const loadLogs = () => {
      if (itemUpdateHelper.item) {
        PageLogStore["a" /* pageLogStore */].resetList();
        PageLogStore["a" /* pageLogStore */].fetchAll({
    ...
    const autoSave = () => {
      PageLogStore["a" /* pageLogStore */].create({
