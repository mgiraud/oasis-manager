...
/* harmony default export */ var contactvue_type_script_lang_ts_ = (Object(runtime["b" /* defineComponent */])({
  ...
  setup() {
    ...
    return {
      headers,
      formatDate,
      ...Object(runtime["q" /* toRefs */])(Object(ItemList["a" /* default */])(ContactStore["a" /* contactStore */], {
        sortBy: ['createdAt'],
        sortDesc: ['desc']
      })),
      ...Object(runtime["q" /* toRefs */])(Object(itemSecurity["a" /* default */])(ContactStore["a" /* contactStore */]))
    };
  }
