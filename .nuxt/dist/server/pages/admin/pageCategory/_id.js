...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./app/pages/admin/pageCategory/_id.vue?vue&type=template&id=0c4ad24c&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('v-container',[(_vm.error)?_c('v-row',[_c('v-col',{attrs:{"cols":"12"}},[_c('v-alert',{attrs:{"type":"error"}},[_vm._v("\n        "+_vm._s(_vm.error)+"\n      ")])],1)],1):_vm._e(),_vm._v(" "),_c('v-row',[_c('v-col',{attrs:{"cols":"12"}},[(_vm.item)?_c('Form',{ref:"updateForm",attrs:{"values":_vm.item,"errors":_vm.violations}}):_vm._e()],1)],1),_vm._v(" "),_c('v-row',[_c('v-col',{attrs:{"cols":"12"}},[_c('Toolbar',{attrs:{"handle-submit":_vm.onSendForm,"handle-reset":_vm.resetForm,"handle-delete":_vm.del,"handle-back":_vm.back},scopedSlots:_vm._u([{key:"left",fn:function(){return [(_vm.item)?_c('h1',[_vm._v("\n            Edit "+_vm._s(_vm.item.name)+"\n          ")]):_vm._e()]},proxy:true}])})],1)],1),_vm._v(" "),_c('Loading',{attrs:{"visible":_vm.isLoading}})],1)}
var staticRenderFns = []


// CONCATENATED MODULE: ./app/pages/admin/pageCategory/_id.vue?vue&type=template&id=0c4ad24c&
...
var Form = __webpack_require__(347);
...
let _idvue_type_script_lang_ts_AdminPageCategoryEdit = class AdminPageCategoryEdit extends Object(external_nuxt_property_decorator_["mixins"])(update["a" /* default */]) {};

__decorate([pageCategoryModule.State('updated')], _idvue_type_script_lang_ts_AdminPageCategoryEdit.prototype, "updated", void 0);

__decorate([pageCategoryModule.State('error')], _idvue_type_script_lang_ts_AdminPageCategoryEdit.prototype, "error", void 0);

__decorate([pageCategoryModule.State('isLoading')], _idvue_type_script_lang_ts_AdminPageCategoryEdit.prototype, "isLoading", void 0);

__decorate([pageCategoryModule.State('violations')], _idvue_type_script_lang_ts_AdminPageCategoryEdit.prototype, "violations", void 0);

__decorate([pageCategoryModule.Getter('find')], _idvue_type_script_lang_ts_AdminPageCategoryEdit.prototype, "find", void 0);

__decorate([pageCategoryModule.Action('resetCreate')], _idvue_type_script_lang_ts_AdminPageCategoryEdit.prototype, "createReset", void 0);

__decorate([pageCategoryModule.Action('resetDelete')], _idvue_type_script_lang_ts_AdminPageCategoryEdit.prototype, "delReset", void 0);

__decorate([pageCategoryModule.Action('load')], _idvue_type_script_lang_ts_AdminPageCategoryEdit.prototype, "retrieve", void 0);

__decorate([pageCategoryModule.Action('update')], _idvue_type_script_lang_ts_AdminPageCategoryEdit.prototype, "update", void 0);

__decorate([pageCategoryModule.Action('resetUpdate')], _idvue_type_script_lang_ts_AdminPageCategoryEdit.prototype, "updateReset", void 0);

_idvue_type_script_lang_ts_AdminPageCategoryEdit = __decorate([Object(external_nuxt_property_decorator_["Component"])({
  components: {
    Loading: Loading["a" /* default */],
    Toolbar: Toolbar["a" /* default */],
    Form: Form["a" /* default */]
  },
  mixins: [update["a" /* default */]],
...
})], _idvue_type_script_lang_ts_AdminPageCategoryEdit);
/* harmony default export */ var _idvue_type_script_lang_ts_ = (_idvue_type_script_lang_ts_AdminPageCategoryEdit);
// CONCATENATED MODULE: ./app/pages/admin/pageCategory/_id.vue?vue&type=script&lang=ts&
 /* harmony default export */ var pageCategory_idvue_type_script_lang_ts_ = (_idvue_type_script_lang_ts_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(10);
...
var component = Object(componentNormalizer["a" /* default */])(
  pageCategory_idvue_type_script_lang_ts_,
  render,
  staticRenderFns,
  false,
  null,
