...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return memberStore; });
/* harmony import */ var _custom_store_AbstractStore__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(28);


class MemberStore extends _custom_store_AbstractStore__WEBPACK_IMPORTED_MODULE_0__[/* PersistentApiStore */ "a"] {
  constructor() {
    super(...arguments);
    this.listRole = 'USER_CAN_ACCESS_MEMBERS';
    this.editRole = 'USER_CAN_EDIT_MEMBERS';
    this.deleteRole = 'USER_CAN_DELETE_MEMBERS';
  }
...
const memberStore = new MemberStore('members');
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./app/pages/admin/member/index.vue?vue&type=template&id=e3d518ea&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('v-container',[_c('v-data-table',{staticClass:"elevation-1",attrs:{"headers":_vm.headers,"items":_vm.filteredItems,"items-per-page":_vm.filterOptions.itemsPerPage,"loading":_vm.state.isLoading,"loading-text":"Loading...","options":_vm.filterOptions,"server-items-length":_vm.state.totalItems,"item-key":"@id","show-select":""},on:{"update:itemsPerPage":function($event){return _vm.$set(_vm.filterOptions, "itemsPerPage", $event)},"update:items-per-page":function($event){return _vm.$set(_vm.filterOptions, "itemsPerPage", $event)},"update:options":[function($event){_vm.filterOptions=$event},_vm.onUpdateOptions]},scopedSlots:_vm._u([{key:"top",fn:function(){return [_c('v-toolbar',{attrs:{"flat":"","color":"white"}},[_c('v-toolbar-title',[_vm._v("Liste de membres")]),_vm._v(" "),_c('v-spacer'),_vm._v(" "),_c('FormFilter',{attrs:{"handle-filter":_vm.onSendFilter,"handle-reset":_vm.resetFilter}},[_c('MemberFilter',{ref:"filterForm",attrs:{"slot":"filter","values":_vm.filters},slot:"filter"})],1)],1)]},proxy:true},{key:"item.actions",fn:function(props){return _c('ActionCell',{attrs:{"handle-edit":_vm.canEdit ? function () { return _vm.editHandler(props.item); } : null}})}}]),model:{value:(_vm.selected),callback:function ($$v) {_vm.selected=$$v},expression:"selected"}})],1)}
var staticRenderFns = []


// CONCATENATED MODULE: ./app/pages/admin/member/index.vue?vue&type=template&id=e3d518ea&
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./app/components/admin/member/MemberFilter.vue?vue&type=template&id=3ca22dff&
var MemberFiltervue_type_template_id_3ca22dff_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('v-container',{attrs:{"fluid":""}},[_vm._v("\n  "+_vm._s(_vm.groups)+"\n  "),_c('v-row',[_c('v-col',{attrs:{"cols":"12","sm":"6","md":"6"}},[_c('v-text-field',{attrs:{"label":"Email du membre","type":"text"},model:{value:(_vm.item.email),callback:function ($$v) {_vm.$set(_vm.item, "email", $$v)},expression:"item.email"}})],1),_vm._v(" "),_c('v-col',{attrs:{"cols":"12","sm":"6","md":"6"}},[_c('v-text-field',{attrs:{"label":"Le pseudo du membre","type":"text"},model:{value:(_vm.item.nickname),callback:function ($$v) {_vm.$set(_vm.item, "nickname", $$v)},expression:"item.nickname"}})],1)],1),_vm._v(" "),_c('v-row',[_c('v-col',{attrs:{"cols":"12","md":"6"}},[_vm._v("\n      "+_vm._s(_vm.item.groups)+"\n      "),(_vm.memberGroupState.selectItems)?_c('v-combobox',{attrs:{"items":_vm.memberGroupState.selectItems,"label":"Dans le groupe","item-text":"name","item-value":"name","clearable":"","return-object":false},model:{value:(_vm.item.groups),callback:function ($$v) {_vm.$set(_vm.item, "groups", $$v)},expression:"item.groups"}}):_vm._e()],1)],1)],1)}
var MemberFiltervue_type_template_id_3ca22dff_staticRenderFns = []
...
/* harmony default export */ var MemberFiltervue_type_script_lang_ts_ = (Object(runtime["b" /* defineComponent */])({
  props: {
    values: {
      type: Object,
      required: true
  ...
  setup(props) {
    ...
    return {
      item,
      memberGroupState: MemberGroupStore["a" /* memberGroupStore */].getState()
    };
  }

}));
// CONCATENATED MODULE: ./app/components/admin/member/MemberFilter.vue?vue&type=script&lang=ts&
 /* harmony default export */ var member_MemberFiltervue_type_script_lang_ts_ = (MemberFiltervue_type_script_lang_ts_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(11);
...
// CONCATENATED MODULE: ./app/components/admin/member/MemberFilter.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  member_MemberFiltervue_type_script_lang_ts_,
  MemberFiltervue_type_template_id_3ca22dff_render,
  MemberFiltervue_type_template_id_3ca22dff_staticRenderFns,
  false,
  null,
  null,
  "db70d7bc"
...
/* harmony default export */ var MemberFilter = (component.exports);
...
var MemberStore = __webpack_require__(343);
...
/* harmony default export */ var membervue_type_script_lang_ts_ = (Object(runtime["b" /* defineComponent */])({
  components: {
  ...
  setup() {
    ...
    const filteredItems = Object(runtime["a" /* computed */])(() => {
...
// CONCATENATED MODULE: ./app/pages/admin/member/index.vue
...
var member_component = Object(componentNormalizer["a" /* default */])(
  admin_membervue_type_script_lang_ts_,
  render,
  staticRenderFns,
  false,
  null,
...
/* harmony default export */ var member = __webpack_exports__["default"] = (member_component.exports);
...
installComponents_default()(member_component, {VContainer: VContainer["a" /* default */],VDataTable: VDataTable["a" /* default */],VSpacer: VSpacer["a" /* default */],VToolbar: VToolbar["a" /* default */],VToolbarTitle: components_VToolbar["a" /* VToolbarTitle */]})
