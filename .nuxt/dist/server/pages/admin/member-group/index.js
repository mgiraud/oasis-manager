...
/* harmony default export */ var member_groupvue_type_script_lang_ts_ = (Object(runtime["b" /* defineComponent */])({
  ...
  setup() {
    ...
    return { ...Object(runtime["q" /* toRefs */])(Object(ItemList["a" /* default */])(MemberGroupStore["a" /* memberGroupStore */])),
      ...Object(runtime["q" /* toRefs */])(Object(itemSecurity["a" /* default */])(MemberGroupStore["a" /* memberGroupStore */])),
      headers
    };
  },
