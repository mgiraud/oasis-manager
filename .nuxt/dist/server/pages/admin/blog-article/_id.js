...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./app/components/admin/blog-article/Form.vue?vue&type=template&id=1d4c7150&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('v-form',[_c('v-container',[_c('v-row',[_c('v-col',{attrs:{"cols":"12"}},[_c('v-text-field',{attrs:{"label":"Titre","error-messages":_vm.titleErrors,"required":""},on:{"input":function($event){return _vm.v$.title.$touch()},"blur":function($event){return _vm.v$.title.$touch()}},model:{value:(_vm.item.title),callback:function ($$v) {_vm.$set(_vm.item, "title", $$v)},expression:"item.title"}})],1)],1),_vm._v(" "),_c('v-row',[_c('v-col',{attrs:{"cols":"12","md":"6"}},[_c('v-switch',{attrs:{"label":"Publier","input-value":"true"},model:{value:(_vm.item.isPublished),callback:function ($$v) {_vm.$set(_vm.item, "isPublished", $$v)},expression:"item.isPublished"}})],1),_vm._v(" "),_c('v-col',{attrs:{"cols":"12","sm":"6","md":"6"}},[(_vm.item.tags)?_c('v-combobox',{attrs:{"items":_vm.item.tags,"no-data-text":"Aucun tag","label":"Tags","return-object":false,"clearable":"","multiple":""},model:{value:(_vm.item.tags),callback:function ($$v) {_vm.$set(_vm.item, "tags", $$v)},expression:"item.tags"}}):_vm._e()],1)],1),_vm._v(" "),_c('v-row',[_c('v-col',[(_vm.state.mediaNodes)?_c('v-combobox',{attrs:{"items":_vm.state.mediaNodes,"no-data-text":"Aucun galerie n'a ce nom","label":"Lier une galerie à cette page","item-text":"name","item-value":"@id","return-object":false,"clearable":""},model:{value:(_vm.item.mediaNode),callback:function ($$v) {_vm.$set(_vm.item, "mediaNode", $$v)},expression:"item.mediaNode"}}):_vm._e()],1)],1),_vm._v(" "),_c('v-row',[_c('v-col',{attrs:{"cols":"12"}},[_c('ClientOnly',[(_vm.item.content !== undefined)?_c('Editor',{model:{value:(_vm.item.content),callback:function ($$v) {_vm.$set(_vm.item, "content", $$v)},expression:"item.content"}}):_vm._e()],1)],1)],1)],1)],1)}
var staticRenderFns = []


// CONCATENATED MODULE: ./app/components/admin/blog-article/Form.vue?vue&type=template&id=1d4c7150&
