...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return memberGroupStore; });
/* harmony import */ var _custom_store_AbstractStore__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(28);


class MemberGroupStore extends _custom_store_AbstractStore__WEBPACK_IMPORTED_MODULE_0__[/* PersistentApiStore */ "a"] {
  constructor() {
    super(...arguments);
    this.listRole = 'USER_CAN_ACCESS_MEMBER_GROUPS';
    this.editRole = 'USER_CAN_EDIT_MEMBER_GROUPS';
    this.deleteRole = 'USER_CAN_DELETE_MEMBER_GROUPS';
  }
...
const memberGroupStore = new MemberGroupStore('member_groups');
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./app/pages/admin/member-group/index.vue?vue&type=template&id=73f7ae4b&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('v-container',[_c('v-data-table',{staticClass:"elevation-1",attrs:{"headers":_vm.headers,"items":_vm.items,"items-per-page":_vm.filterOptions.itemsPerPage,"loading":_vm.state.isLoading,"loading-text":"Loading...","options":_vm.filterOptions,"server-items-length":_vm.state.totalItems,"item-key":"@id","show-select":""},on:{"update:itemsPerPage":function($event){return _vm.$set(_vm.filterOptions, "itemsPerPage", $event)},"update:items-per-page":function($event){return _vm.$set(_vm.filterOptions, "itemsPerPage", $event)},"update:options":[function($event){_vm.filterOptions=$event},_vm.onUpdateOptions]},scopedSlots:_vm._u([{key:"top",fn:function(){return [_c('v-toolbar',{attrs:{"flat":"","color":"white"}},[_c('v-toolbar-title',[_vm._v("Groupe de membres")]),_vm._v(" "),_c('v-spacer'),_vm._v(" "),_c('FormFilter',{attrs:{"handle-filter":_vm.onSendFilter,"handle-reset":_vm.resetFilter}},[_c('MemberGroupFilter',{ref:"filterForm",attrs:{"slot":"filter","values":_vm.filters},slot:"filter"})],1),_vm._v(" "),_c('v-btn',{staticClass:"ml-2",attrs:{"color":"primary","dark":""},on:{"click":_vm.addHandler}},[_vm._v("\n          New Item\n        ")])],1)]},proxy:true},{key:"item.category",fn:function(ref){
var item = ref.item;
return (item && item.category)?[_c('nuxt-link',{attrs:{"to":{name: 'admin-member-group-id', params: {id: item.category.id }}}},[_vm._v("\n        "+_vm._s(item.category.name)+"\n      ")])]:undefined}},{key:"item.actions",fn:function(props){return _c('ActionCell',{attrs:{"handle-edit":_vm.canEdit ? function () { return _vm.editHandler(props.item); } : null,"handle-delete":_vm.canDelete ? function () { return _vm.deleteHandler(props.item); } : null}})}}],null,true),model:{value:(_vm.selected),callback:function ($$v) {_vm.selected=$$v},expression:"selected"}})],1)}
var staticRenderFns = []


// CONCATENATED MODULE: ./app/pages/admin/member-group/index.vue?vue&type=template&id=73f7ae4b&
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./app/components/admin/memberGroup/MemberGroupFilter.vue?vue&type=template&id=05d17ce0&
var MemberGroupFiltervue_type_template_id_05d17ce0_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('v-container',{attrs:{"fluid":""}},[_c('v-row',[_c('v-col',{attrs:{"cols":"12"}},[_c('v-text-field',{attrs:{"label":"Le nom contient...","type":"text"},model:{value:(_vm.item.name),callback:function ($$v) {_vm.$set(_vm.item, "name", $$v)},expression:"item.name"}})],1)],1)],1)}
var MemberGroupFiltervue_type_template_id_05d17ce0_staticRenderFns = []
...
/* harmony default export */ var MemberGroupFiltervue_type_script_lang_ts_ = (Object(runtime["b" /* defineComponent */])(filterComponent["a" /* default */]));
// CONCATENATED MODULE: ./app/components/admin/memberGroup/MemberGroupFilter.vue?vue&type=script&lang=ts&
 /* harmony default export */ var memberGroup_MemberGroupFiltervue_type_script_lang_ts_ = (MemberGroupFiltervue_type_script_lang_ts_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(11);
...
// CONCATENATED MODULE: ./app/components/admin/memberGroup/MemberGroupFilter.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  memberGroup_MemberGroupFiltervue_type_script_lang_ts_,
  MemberGroupFiltervue_type_template_id_05d17ce0_render,
  MemberGroupFiltervue_type_template_id_05d17ce0_staticRenderFns,
  false,
  null,
  null,
  "5f15e66e"
...
/* harmony default export */ var MemberGroupFilter = (component.exports);
...
var MemberGroupStore = __webpack_require__(298);
...
/* harmony default export */ var member_groupvue_type_script_lang_ts_ = (Object(runtime["b" /* defineComponent */])({
  components: {
  ...
  setup() {
    ...
    Object(runtime["r" /* useFetch */])(async () => {
      await MemberGroupStore["a" /* memberGroupStore */].fetchAll();
    });
    return { ...Object(runtime["p" /* toRefs */])(Object(ItemList["a" /* default */])(MemberGroupStore["a" /* memberGroupStore */])),
      ...Object(runtime["p" /* toRefs */])(Object(itemSecurity["a" /* default */])(MemberGroupStore["a" /* memberGroupStore */])),
      headers
    };
  },
...
// CONCATENATED MODULE: ./app/pages/admin/member-group/index.vue?vue&type=script&lang=ts&
 /* harmony default export */ var admin_member_groupvue_type_script_lang_ts_ = (member_groupvue_type_script_lang_ts_); 
// EXTERNAL MODULE: ./node_modules/vuetify/lib/components/VBtn/VBtn.js
var VBtn = __webpack_require__(46);
...
// CONCATENATED MODULE: ./app/pages/admin/member-group/index.vue
...
var member_group_component = Object(componentNormalizer["a" /* default */])(
  admin_member_groupvue_type_script_lang_ts_,
  render,
  staticRenderFns,
  false,
  null,
...
/* harmony default export */ var member_group = __webpack_exports__["default"] = (member_group_component.exports);
...
installComponents_default()(member_group_component, {VBtn: VBtn["a" /* default */],VContainer: VContainer["a" /* default */],VDataTable: VDataTable["a" /* default */],VSpacer: VSpacer["a" /* default */],VToolbar: VToolbar["a" /* default */],VToolbarTitle: components_VToolbar["a" /* VToolbarTitle */]})
