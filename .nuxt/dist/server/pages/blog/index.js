...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./app/pages/blog/index.vue?vue&type=template&id=39104d24&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('v-container',{attrs:{"fill-height":""}},[_c('v-row',[_c('v-col',[_c('v-card',[_c('v-container',{attrs:{"fluid":""}},_vm._l((_vm.articles),function(article){return _c('v-row',{key:article['@id']},[_c('v-col',[_c('blog-article-template',{attrs:{"article":article}})],1)],1)}),1)],1)],1)],1)],1)}
var staticRenderFns = []


// CONCATENATED MODULE: ./app/pages/blog/index.vue?vue&type=template&id=39104d24&

// EXTERNAL MODULE: ./node_modules/@nuxtjs/composition-api/dist/runtime/index.mjs + 1 modules
var runtime = __webpack_require__(3);

// EXTERNAL MODULE: ./app/components/blog-article/BlogArticleTemplate.vue + 4 modules
var BlogArticleTemplate = __webpack_require__(349);
...
/* harmony default export */ var blogvue_type_script_lang_ts_ = (Object(runtime["b" /* defineComponent */])({
  ...
  setup() {
    ...
    const articles = Object(runtime["a" /* computed */])(() => {
      return BlogArticleStore["a" /* blogArticleStore */].list.value;
    });
